    ...
    def save_pretrained(
        ...
        **kwargs,
        ...
        if "device_map" in tokenizer_config and not isinstance(tokenizer_config["device_map"], str):
            raise TypeError(f"'device_map' is not in str type, got {tokenizer_config["device_map"]}. Please set the value in str format (e.g. 'auto') or do not pass it into tokenizer (for TPU).")
